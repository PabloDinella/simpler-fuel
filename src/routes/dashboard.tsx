      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <h1 className="text-3xl font-bold text-gray-900">⛽ Simpler Fuel</h1>
            {!isLoggedIn && (
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ...
          >
            ...
            <p className="text-sm text-blue-100 mt-1">Record new fuel entry</p>
          </Link>
          ...
          >
            ...
            <p className="text-gray-600 text-sm mt-1">Units & preferences</p>
          </Link>
        </div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-sm text-gray-500">{getConsumptionFormatLabel(settings.consumptionFormat)}</p>
              </div>

              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="text-sm font-medium text-gray-600 mb-2">Best</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-sm text-gray-500">{getDistanceUnitLabel(settings.distanceUnit)}</p>
              </div>

              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="text-sm font-medium text-gray-600 mb-2">Total Fuel</h3>
                <p className="text-2xl font-bold text-gray-800">
                  {formatNumber(stats.totalFuel, 1)}
                </p>
                <p className="text-sm text-gray-500">{getVolumeUnitLabel(settings.volumeUnit)}</p>
              </div>
            </div>
          </div>
        )}
        ...
        {/* Recent History */}
        <div>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">All Entries</h2>
