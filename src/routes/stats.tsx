      ...
      <div className="min-h-screen bg-gray-50 p-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-lg shadow text-center">
            <p className="text-gray-600 mb-4">{t('stats.needMoreEntries')}</p>
            <Link
              to="/add"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-3xl font-bold text-gray-800">
              {formatNumber(totalDistanceDisplay, 0)}{' '}
              <span className="text-lg">{getDistanceUnitLabel(settings.distanceUnit)}</span>
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-3xl font-bold text-gray-800">
              {formatNumber(totalFuelDisplay, 1)}{' '}
              <span className="text-lg">{getVolumeUnitLabel(settings.volumeUnit)}</span>
            </p>
          </div>
        </div>
